...
**For content editors** — A page builder with 12 block types. Create pages by stacking blocks (hero banners, text sections, card grids, Quran verses, logo grids, etc.) and configuring them via the admin panel.
...
- `teachers.jpg` — image for the teachers section
- `logo-talaqqi.png`, `logo-barash.png`, `logo-foundation.png` — logos for the works section
...
app/
    Services/
        BlockRegistry.php       # Central registry of all 12 block types
        BlockDataResolver.php   # Hydrates dynamic blocks with cached data
    Http/Controllers/
        Admin/
            PageController.php
...
resources/js/
    Components/
        Blocks/                 # 12 block components + BlockRenderer.jsx
        Decorative/             # IslamicStar, ScatteredStars, OrnamentalDivider, DotPattern
    Layouts/
        PublicLayout.jsx        # Header + dark footer
        AdminLayout.jsx
    Pages/
        PageDisplay.jsx         # Public page renderer
        Admin/PageBlocks/
            Form.jsx            # Block editor with all field types
